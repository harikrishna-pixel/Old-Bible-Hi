...
// import 'package:biblebookapp/view/screens/In_aap_purchase/subscription_db_service.dart';
// import 'package:biblebookapp/view/widget/colors.dart';
...
// //Subscription 01
// String sub1Id = Platform.isAndroid ? 'com.balaklrapps.englishbible.3monauto' : 'your_ios_sub1_id';

// //Subscription 02
// String sub2Id = Platform.isAndroid ? 'com.balaklrapps.englishbible.sixmonths' : 'your_ios_sub2_id';
...
//                                           letterSpacing: BibleInfo.letterSpacing ,  fontSize: BibleInfo.fontSizeScale * 22,
//                                           color: Colors.black,
...
//                                 height: 10,
//                               ),
//                               if (!_notFoundIds.contains(sub2Id) && _isAvailable)
//                                 _buildYearlySubTile(),
...
//                               color: Colors.white,
//                               letterSpacing: BibleInfo.letterSpacing ,  fontSize: BibleInfo.fontSizeScale * 18)),
//                     ),
//                     const SizedBox(
//                       height: 5,
//                     ),
...
//                         // 'Price',
//                         style: const TextStyle(
//                             letterSpacing: BibleInfo.letterSpacing ,  fontSize: BibleInfo.fontSizeScale * 30,
//                             fontWeight: FontWeight.w500,
//                             color: Colors.white)),
//                     const SizedBox(
//                       height: 5,
...
//                             'Price Change',
//                             style: TextStyle(
//                                 letterSpacing: BibleInfo.letterSpacing ,  fontSize: BibleInfo.fontSizeScale * 12,
//                                 color: Colors.white,
//                                 fontWeight: FontWeight.w500),
//                           ),
//                         ),
...
//                   style: TextStyle(color: AppColors.c3, letterSpacing: BibleInfo.letterSpacing ,  fontSize: BibleInfo.fontSizeScale * 16)),
//             ),
//             const SizedBox(
//               height: 20,
//             ),
...
//                   style: const TextStyle(
//                       letterSpacing: BibleInfo.letterSpacing ,  fontSize: BibleInfo.fontSizeScale * 16,
//                       color: Colors.white,
//                       fontWeight: FontWeight.w500),
//                 ),
//               ),
